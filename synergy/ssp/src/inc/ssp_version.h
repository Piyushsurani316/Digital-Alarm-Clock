...
#define SSP_VERSION_STRING                  ("2.6.1")

/** Unique SSP version ID. */
#define SSP_VERSION_BUILD_STRING            ("Built with Renesas Synergy (TM) Software Package version 2.6.1+build.2de4e254280f7be3a0af0d6786676b983b1f0f44")
